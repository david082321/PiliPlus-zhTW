...
class _CreateReservePageState extends State<CreateReservePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('新增直播預約')),
      body: ListView(
        ...
        children: [
          Row(
            ...
            children: [
              SizedBox(
                width: 65,
                child: Text('類型', style: _leadingStyle),
              ),
              Obx(
                () => PopupMenuButton(
                  requestFocus: false,
                  ...
                  child: Text(
                    _controller.subType.value == 0 ? '公開直播' : '大航海直播',
                  ),
                ),
              ),
            ],
          ...
          Row(
            ...
            children: [
              SizedBox(
                width: 65,
                child: Text('時間', style: _leadingStyle),
              ),
              Expanded(
